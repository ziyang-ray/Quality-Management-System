...
class Configuration(BaseModel):
    ...
    clause_store_path: str = Field(
        default="data/standard_clauses/clauses.jsonl",
        metadata={
            "x_oap_ui_config": {
                "type": "text",
                "default": "data/standard_clauses/clauses.jsonl",
                "description": "Path to the extracted standard clauses JSONL file for clause-driven review"
            }
        }
    )
