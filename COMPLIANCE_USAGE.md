...
## 3. Extract Candidate Standard Clauses
...
## 4. Generate A Compliance Report From CLI
...
3. Tune retrieval if evidence is wrong.
4. Run the CLI or LangGraph Studio to generate the report.
5. Review the report manually before treating any finding as a quality-system conclusion.
